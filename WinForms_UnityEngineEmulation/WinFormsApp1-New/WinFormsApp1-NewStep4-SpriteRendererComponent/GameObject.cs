...
namespace WinFormsApp1
{
    ...
    public class SpriteRenderer : Renderer
    {
        ...
        public override void OnRenderObject(Graphics g)
        {
            Rectangle rect = new Rectangle((int)gameObject.transform.position.X
                , (int)gameObject.transform.position.Y, 40, 40);
            g.FillRectangle(_brush ?? new SolidBrush(Color.White), rect);
        }
    }
